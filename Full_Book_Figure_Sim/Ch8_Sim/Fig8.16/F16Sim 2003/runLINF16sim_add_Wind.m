...
%%
[A_hi,B_hi,C_hi,D_hi] = linmod('LIN_F16Block_add_Wind', [trim_state_lin; trim_thrust_lin; trim_control_lin(1); trim_control_lin(2); trim_control_lin(3); dLEF; -trim_state_lin(8)*180/pi], [trim_thrust_lin; trim_control_lin(1); trim_control_lin(2); trim_control_lin(3);0;0;0;0;0;0]);
% linmode('Simulink名称'，状态初值，控制值)？？
...
%% Find the state space model for the hifi model at the desired alt and vel.
%%
[A_lo,B_lo,C_lo,D_lo] = linmod('LIN_F16Block_add_Wind', [trim_state_lin; trim_thrust_lin; trim_control_lin(1); trim_control_lin(2); trim_control_lin(3); dLEF; -trim_state_lin(8)*180/pi], [trim_thrust_lin; trim_control_lin(1); trim_control_lin(2); trim_control_lin(3);0;0;0;0;0;0]);
