...
figure(1)
subplot(2,2,1)
plot(u_T(:,1),u_Ideal_x(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-1,12])
xlabel('Time(s)','fontsize',font_size)
% ylabel('$x_{r,k}$(m)', 'Interpreter', 'latex','fontsize',font_size)
ylabel('$x_{r,k}$(m)', 'Interpreter', 'latex')
hold on
grid on

subplot(2,2,2)
plot(u_T(:,1),u_Ideal_y(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-0.2,1.2])
xlabel('Time(s)','fontsize',font_size)
ylabel('$y_{r,k}$(m)', 'Interpreter', 'latex')
hold on
grid on
subplot(2,2,3)
plot(u_T(:,1),u_Ideal_z(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-1.2,0.2])
xlabel('Time(s)','fontsize',font_size)
ylabel('$z_{r,k}$(m)', 'Interpreter', 'latex')
hold on
grid on
subplot(2,2,4)
plot(u_T(:,1),Ideal_v(:,1),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-0.2,1.5])
xlabel('Time(s)','fontsize',font_size)
ylabel('$v_{r,x,k}$(m/s)', 'Interpreter', 'latex')
hold on
grid on
...
figure(1)
subplot(2,2,1)
h = legend('$k=\rm{d}$','$k=2$','$k=5$','$k=20$','Interpreter', 'latex', 'Location', 'best');
%set(h,'Fontsize',font_size-6);
subplot(2,2,2)
h = legend('$k=\rm{d}$','$k=2$','$k=5$','$k=20$','Interpreter', 'latex', 'Location', 'best');%set(h,'Fontsize',font_size-6);
subplot(2,2,3)
...
figure(2)        %迭代学习产生的外环输入
% set(gcf,'color',[1 1 1])
subplot(2,2,1)
plot(u_T(:,1),u_T(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-10,90])
xlabel('Time(s)','fontsize',font_size)
ylabel('$\delta_{\rm{T,r}}$', 'Interpreter', 'latex')
% ylabel('u_T_,_b_a_r','fontsize',font_size+5,'fontname','Times New Roman')
grid on
subplot(2,2,2)
plot(u_T(:,1),u_a(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-10,2])
xlabel('Time(s)','fontsize',font_size)
ylabel('$\delta_{\rm{a,r}}$', 'Interpreter', 'latex')
grid on
subplot(2,2,3)
plot(u_T(:,1),u_e(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-5,2])
xlabel('Time(s)','fontsize',font_size)
ylabel('$\delta_{\rm{e,r}}$', 'Interpreter', 'latex')
grid on
subplot(2,2,4)
plot(u_T(:,1),u_r(:,2),'Color', [0 0 0], 'LineStyle', '-', 'LineWidth', line_width)
set(gca,'FontSize',font_size)
xlim([0,50])
set(gca,'XTick',0:10:50) 
ylim([-0.5,1.5])
xlabel('Time(s)','fontsize',font_size)
ylabel('$\delta_{\rm{r,r}}$', 'Interpreter', 'latex')
grid on
