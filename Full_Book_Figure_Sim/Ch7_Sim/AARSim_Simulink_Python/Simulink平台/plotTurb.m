...
figure(1)
set(gcf,'color',[1 1 1])
plot(uvw(:,4),uvw(:,1),'linewidth',2)
hold on
grid on
plot(uvw(:,4),uvw(:,2),'linewidth',2)
hold on
plot(uvw(:,4),uvw(:,3),'linewidth',2)
h = legend('Vx','Vy','Vz');
set(h,'Fontsize',14);
set(gca,'FontSize',14)
...
figure(2)
set(gcf,'color',[1 1 1])
plot(pqr(:,4),pqr(:,1),'linewidth',2)
hold on
grid on
plot(pqr(:,4),pqr(:,2),'linewidth',2)
hold on
plot(pqr(:,4),pqr(:,3),'linewidth',2)
h = legend('Wp','Wq','Wr');
set(h,'Fontsize',14);
set(gca,'FontSize',14)