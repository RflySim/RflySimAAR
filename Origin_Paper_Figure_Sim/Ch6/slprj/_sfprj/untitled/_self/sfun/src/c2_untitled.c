...
static void sf_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  c2_e_u = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_e_u, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_e_y, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_e_u;
  c2_u = c2_hoistedGlobal;
  ...
  sf_mex_call_debug("place", 0U, 3U, 14, c2_b_y, 14, c2_c_y, 14, c2_d_y);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3747378193U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4154519835U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1302995941U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(446623297U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Wyy3Mr8QrgwtSHk0rbM0LE");
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2081921015U));
  ssSetChecksum1(S,(1456554222U));
  ssSetChecksum2(S,(2488526728U));
  ssSetChecksum3(S,(3123976006U));
