  ...
  real_T c3_y[154])
{
  real_T c3_dv1[154];
  int32_T c3_i52;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv1, 1, 0, 0U, 1, 0U, 1, 154);
  ...
  real_T c3_y[88])
{
  real_T c3_dv5[88];
  int32_T c3_i81;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv5, 1, 0, 0U, 1, 0U, 1, 88);
  for (c3_i81 = 0; c3_i81 < 88; c3_i81++) {
    c3_y[c3_i81] = c3_dv5[c3_i81];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3137094598U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1582994555U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2973645216U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2717852150U);
}
...
mxArray *sf_c3_DrogueVisualNavigation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("RCVBrLB2xZ7xOmi1rxhwC");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1601);
...
static void mdlSetWorkWidths_c3_DrogueVisualNavigation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1634407494U));
  ssSetChecksum1(S,(1625761899U));
  ssSetChecksum2(S,(3332421829U));
  ssSetChecksum3(S,(2153636410U));
