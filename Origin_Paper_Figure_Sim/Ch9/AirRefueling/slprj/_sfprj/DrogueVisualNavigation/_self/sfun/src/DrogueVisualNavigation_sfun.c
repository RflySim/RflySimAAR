  ...
  * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(893930228U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2157999582U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3276736105U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3568651059U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3675787774U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3104971078U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2839649093U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1321004256U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "RCVBrLB2xZ7xOmi1rxhwC") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "4cazdS9b6SoVo0dGEfIih") == 0) {
  ...
  debugInstance)
{
  _DrogueVisualNavigationMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"DrogueVisualNavigation","sfun",0,1,0,0,0);
