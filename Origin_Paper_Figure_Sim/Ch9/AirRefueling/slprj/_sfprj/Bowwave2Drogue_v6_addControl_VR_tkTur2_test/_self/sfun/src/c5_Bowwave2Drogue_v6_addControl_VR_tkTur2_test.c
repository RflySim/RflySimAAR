...
#include "c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test.h"
...
static void initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance,
   const mxArray *c5_st);
static void finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
static void registerMessagesc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance,
   const mxArray *c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test,
  ...
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test =
    0U;
}
   ...
   const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test =
    ...
    "is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test");
  sf_mex_destroy(&c5_u);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance;
  chartInstance =
    (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test);
  return c5_y;
}
...
void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_get_check_sum(mxArray
  *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2574668422U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2856459729U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3888219886U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3278004656U);
}

mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("67dYj72g2HwXTBMjyfEmiC");
...
mxArray *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_get_check_sum(&mxChecksum);
...
{
  return "AU2OzccBOAEpPP1tLuzMYB";
}

static void sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
  initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(void
  *chartInstanceVar)
{
  enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (void *chartInstanceVar)
{
  disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (void *chartInstanceVar)
{
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test();/* state var info */
...
extern void
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(S);
}

static void
  sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(S, st);
}

static void sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
      ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(371452374U));
  ssSetChecksum1(S,(863132037U));
  ssSetChecksum2(S,(222614194U));
  ssSetChecksum3(S,(2529560876U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(SimStruct *S)
{
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *chartInstance;
  chartInstance =
    (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct *)utMalloc
    (sizeof(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test;
...
void c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_test_method_dispatcher.\n"
