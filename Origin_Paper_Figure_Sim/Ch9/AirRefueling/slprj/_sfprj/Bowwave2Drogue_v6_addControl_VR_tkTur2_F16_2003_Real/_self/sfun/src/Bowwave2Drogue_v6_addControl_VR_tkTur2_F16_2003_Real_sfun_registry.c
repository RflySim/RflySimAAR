  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real")
      == 0) {
...
extern void Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_terminator();
...
extern void Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_initializer
  (void);
extern void
  Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_register_exported_symbols
  (SimStruct* S);
extern void
  Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_debug_initialize(struct
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_initializer();
  }
