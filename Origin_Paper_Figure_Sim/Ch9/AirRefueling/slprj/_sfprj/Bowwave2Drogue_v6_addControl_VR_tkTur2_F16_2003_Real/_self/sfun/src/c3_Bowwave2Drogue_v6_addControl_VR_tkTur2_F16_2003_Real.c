...
#include <stddef.h>
#include "blas.h"
#include "Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_sfun.h"
#include "c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_sfun_debug_macros.h"
...
static void initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
...
static const mxArray
  *get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void
  set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance, const mxArray *c3_st);
static void finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void
  initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
static void
  registerMessagesc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
   *chartInstance);
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_
    = 0U;
}
   ...
   *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_
    ...
    "is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real");
  sf_mex_destroy(&c3_u);
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealMachineNumber_,
...
const mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_get_eml_resolved_functions_info
  (void)
{
...
void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_get_check_sum
  (mxArray *plhs[])
{
...
mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_get_autoinheritance_info
  (void)
{
...
mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"y\",},{M[8],M[0],T\"is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_get_check_sum
    (&mxChecksum);
...
static void
  sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (void *chartInstanceVar)
{
  ...
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
     chartInstanceVar);
  initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real(void *
  chartInstanceVar)
{
  enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real(void
  *chartInstanceVar)
{
  disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real(void
  *chartInstanceVar)
{
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct* S)
{
...
extern void
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
...
static void
  sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
    (S, st);
...
static void
  sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      ...
      unload_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_optimization_info
        ();
    }

    finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
      ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct*)
       chartInstanceVar);
...
static void
  mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct *S)
{
  int i;
...
static void
  mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_optimization_info
      ();
...
static void mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real
  (SimStruct *S)
{
  SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_RealInstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  ...
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real;
...
void c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real(S);
    break;
   ...
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_Real_method_dispatcher.\n"
