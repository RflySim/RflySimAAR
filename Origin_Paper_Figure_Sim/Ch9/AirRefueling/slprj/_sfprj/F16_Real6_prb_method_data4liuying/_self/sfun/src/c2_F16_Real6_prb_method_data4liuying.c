...
static void initialize_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initialize_params_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void enable_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void disable_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void set_sim_state_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void sf_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c2_chartstep_c2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initSimStructsc2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void registerMessagesc2_F16_Real6_prb_method_data4liuying
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
...
static real_T c2_mpower(SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_F16_Real6_prb_method_data4liuying, const char_T
   *c2_identifier);
  ...
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_F16_Real6_prb_method_data4liuying = 0U;
}
  ...
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_F16_Real6_prb_method_data4liuying;
   ...
   mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_F16_Real6_prb_method_data4liuying =
    ...
    "is_active_c2_F16_Real6_prb_method_data4liuying");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_F16_Real6_prb_method_data4liuying(chartInstance);
  ...
  (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_F16_Real6_prb_method_data4liuying(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    chartInstanceVoid;
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_F16_Real6_prb_method_data4liuying), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_F16_Real6_prb_method_data4liuying);
  return c2_y;
}
...
void sf_c2_F16_Real6_prb_method_data4liuying_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_F16_Real6_prb_method_data4liuying_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_F16_Real6_prb_method_data4liuying_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_F16_Real6_prb_method_data4liuying
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_F16_Real6_prb_method_data4liuying\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_F16_Real6_prb_method_data4liuying_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
  initialize_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  enable_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  disable_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  sf_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_F16_Real6_prb_method_data4liuying();/* state var info */
...
extern void sf_internal_set_sim_state_c2_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_F16_Real6_prb_method_data4liuying(S);
}

static void sf_opaque_set_sim_state_c2_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_F16_Real6_prb_method_data4liuying(S, st);
}

static void sf_opaque_terminate_c2_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_F16_Real6_prb_method_data4liuying
      ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_F16_Real6_prb_method_data4liuying
    ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_F16_Real6_prb_method_data4liuying(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_F16_Real6_prb_method_data4liuying
      ((SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    utMalloc(sizeof(SFc2_F16_Real6_prb_method_data4liuyingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_F16_Real6_prb_method_data4liuying;
...
void c2_F16_Real6_prb_method_data4liuying_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_F16_Real6_prb_method_data4liuying(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_F16_Real6_prb_method_data4liuying_method_dispatcher.\n"
