...
#include "c4_F16_Real6_prb_method_data4liuying.h"
...
static void initialize_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initialize_params_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void enable_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void disable_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void set_sim_state_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c4_st);
static void finalize_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void sf_c4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initSimStructsc4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void registerMessagesc4_F16_Real6_prb_method_data4liuying
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c4_b_is_active_c4_F16_Real6_prb_method_data4liuying, const char_T
   *c4_identifier);
  ...
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_F16_Real6_prb_method_data4liuying = 0U;
}
  ...
  (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal =
    chartInstance->c4_is_active_c4_F16_Real6_prb_method_data4liuying;
   ...
   mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_F16_Real6_prb_method_data4liuying =
    ...
    "is_active_c4_F16_Real6_prb_method_data4liuying");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_F16_Real6_prb_method_data4liuying(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    chartInstanceVoid;
   ...
   *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_F16_Real6_prb_method_data4liuying), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_F16_Real6_prb_method_data4liuying);
  return c4_y;
}
...
void sf_c4_F16_Real6_prb_method_data4liuying_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_F16_Real6_prb_method_data4liuying_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_F16_Real6_prb_method_data4liuying_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c4_F16_Real6_prb_method_data4liuying
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_F16_Real6_prb_method_data4liuying\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_F16_Real6_prb_method_data4liuying_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
  initialize_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  enable_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  disable_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  sf_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c4_F16_Real6_prb_method_data4liuying();/* state var info */
...
extern void sf_internal_set_sim_state_c4_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_F16_Real6_prb_method_data4liuying(S);
}

static void sf_opaque_set_sim_state_c4_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_F16_Real6_prb_method_data4liuying(S, st);
}

static void sf_opaque_terminate_c4_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c4_F16_Real6_prb_method_data4liuying
      ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_F16_Real6_prb_method_data4liuying
    ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_F16_Real6_prb_method_data4liuying(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_F16_Real6_prb_method_data4liuying
      ((SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c4_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    utMalloc(sizeof(SFc4_F16_Real6_prb_method_data4liuyingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_F16_Real6_prb_method_data4liuying;
...
void c4_F16_Real6_prb_method_data4liuying_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_F16_Real6_prb_method_data4liuying(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_F16_Real6_prb_method_data4liuying_method_dispatcher.\n"
