...
static void initialize_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initialize_params_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void enable_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void disable_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void set_sim_state_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c6_st);
static void finalize_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void sf_c6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initSimStructsc6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void registerMessagesc6_F16_Real6_prb_method_data4liuying
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c6_TankerVortexWindField
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, real_T
...
static real_T c6_mpower(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct
  *chartInstance, real_T c6_a);
static void c6_eml_scalar_eg
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static real_T c6_sqrt(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct
                      *chartInstance, real_T c6_x);
static void c6_eml_error(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct
  *chartInstance);
static real_T c6_abs(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct
                     *chartInstance, real_T c6_x);
...
static uint8_T c6_e_emlrt_marshallIn
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c6_b_is_active_c6_F16_Real6_prb_method_data4liuying, const char_T
   *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sqrt(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct
                      *chartInstance, real_T *c6_x);
  ...
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_F16_Real6_prb_method_data4liuying = 0U;
}
  ...
  (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal =
    chartInstance->c6_is_active_c6_F16_Real6_prb_method_data4liuying;
   ...
   mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_F16_Real6_prb_method_data4liuying =
    ...
    "is_active_c6_F16_Real6_prb_method_data4liuying");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_F16_Real6_prb_method_data4liuying(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c6_F16_Real6_prb_method_data4liuying_get_eml_resolved_functions_info(void)
{
   ...
   *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_F16_Real6_prb_method_data4liuying), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_F16_Real6_prb_method_data4liuying);
  return c6_y;
}
...
void sf_c6_F16_Real6_prb_method_data4liuying_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_F16_Real6_prb_method_data4liuying_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_F16_Real6_prb_method_data4liuying_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_F16_Real6_prb_method_data4liuying
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"TkTur2dr\",},{M[8],M[0],T\"is_active_c6_F16_Real6_prb_method_data4liuying\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_F16_Real6_prb_method_data4liuying_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
  initialize_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  enable_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  disable_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  sf_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c6_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c6_F16_Real6_prb_method_data4liuying();/* state var info */
...
extern void sf_internal_set_sim_state_c6_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c6_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_F16_Real6_prb_method_data4liuying(S);
}

static void sf_opaque_set_sim_state_c6_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_F16_Real6_prb_method_data4liuying(S, st);
}

static void sf_opaque_terminate_c6_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c6_F16_Real6_prb_method_data4liuying
      ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_F16_Real6_prb_method_data4liuying
    ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_F16_Real6_prb_method_data4liuying(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_F16_Real6_prb_method_data4liuying
      ((SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c6_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    utMalloc(sizeof(SFc6_F16_Real6_prb_method_data4liuyingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c6_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_F16_Real6_prb_method_data4liuying;
...
void c6_F16_Real6_prb_method_data4liuying_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_F16_Real6_prb_method_data4liuying(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_F16_Real6_prb_method_data4liuying_method_dispatcher.\n"
