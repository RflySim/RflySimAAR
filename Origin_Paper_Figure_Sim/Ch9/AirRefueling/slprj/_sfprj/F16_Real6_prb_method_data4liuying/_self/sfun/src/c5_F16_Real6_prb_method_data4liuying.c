...
static void initialize_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initialize_params_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void enable_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void disable_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void set_sim_state_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void sf_c5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void initSimStructsc5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void registerMessagesc5_F16_Real6_prb_method_data4liuying
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static void c5_TankerVortexWindField
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, real_T
...
static real_T c5_mpower(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct
  *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance);
static real_T c5_sqrt(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct
                      *chartInstance, real_T c5_x);
static void c5_eml_error(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct
  *chartInstance);
static real_T c5_abs(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct
                     *chartInstance, real_T c5_x);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_F16_Real6_prb_method_data4liuying, const char_T
   *c5_identifier);
static uint8_T c5_g_emlrt_marshallIn
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sqrt(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct
                      *chartInstance, real_T *c5_x);
  ...
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real6_prb_method_data4liuying = 0U;
}
  ...
  (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal =
    chartInstance->c5_is_active_c5_F16_Real6_prb_method_data4liuying;
   ...
   mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real6_prb_method_data4liuying =
    ...
    "is_active_c5_F16_Real6_prb_method_data4liuying");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_F16_Real6_prb_method_data4liuying(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_F16_Real6_prb_method_data4liuying_get_eml_resolved_functions_info(void)
{
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_F16_Real6_prb_method_data4liuying), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_F16_Real6_prb_method_data4liuying);
  return c5_y;
}
...
void sf_c5_F16_Real6_prb_method_data4liuying_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_F16_Real6_prb_method_data4liuying_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_F16_Real6_prb_method_data4liuying_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_F16_Real6_prb_method_data4liuying
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_F16_Real6_prb_method_data4liuying\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_F16_Real6_prb_method_data4liuying_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
  initialize_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  enable_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  disable_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  sf_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_F16_Real6_prb_method_data4liuying();/* state var info */
...
extern void sf_internal_set_sim_state_c5_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_F16_Real6_prb_method_data4liuying(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_F16_Real6_prb_method_data4liuying(S);
}

static void sf_opaque_set_sim_state_c5_F16_Real6_prb_method_data4liuying
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_F16_Real6_prb_method_data4liuying(S, st);
}

static void sf_opaque_terminate_c5_F16_Real6_prb_method_data4liuying(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_F16_Real6_prb_method_data4liuying
      ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_F16_Real6_prb_method_data4liuying
    ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_F16_Real6_prb_method_data4liuying(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_F16_Real6_prb_method_data4liuying
      ((SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_F16_Real6_prb_method_data4liuying(SimStruct *S)
{
  SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct *)
    utMalloc(sizeof(SFc5_F16_Real6_prb_method_data4liuyingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_F16_Real6_prb_method_data4liuying;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_F16_Real6_prb_method_data4liuying;
...
void c5_F16_Real6_prb_method_data4liuying_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_F16_Real6_prb_method_data4liuying(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_F16_Real6_prb_method_data4liuying(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_F16_Real6_prb_method_data4liuying_method_dispatcher.\n"
