...
static void initialize_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance);
static void initialize_params_c5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance);
static void enable_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance);
static void disable_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance);
static void set_sim_state_c5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance);
static void sf_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance);
static void initSimStructsc5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance);
static void registerMessagesc5_F16_Real3(SFc5_F16_Real3InstanceStruct
  *chartInstance);
static void c5_TankerVortexWindField(SFc5_F16_Real3InstanceStruct *chartInstance,
  real_T c5_PosReceiver[3], real_T c5_y[3]);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c5_y, const char_T *c5_identifier, real_T c5_b_y[6]);
static void c5_b_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_d_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
...
static real_T c5_mpower(SFc5_F16_Real3InstanceStruct *chartInstance, real_T c5_a);
static void c5_eml_scalar_eg(SFc5_F16_Real3InstanceStruct *chartInstance);
static real_T c5_sqrt(SFc5_F16_Real3InstanceStruct *chartInstance, real_T c5_x);
static void c5_eml_error(SFc5_F16_Real3InstanceStruct *chartInstance);
static real_T c5_abs(SFc5_F16_Real3InstanceStruct *chartInstance, real_T c5_x);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_e_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_f_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_F16_Real3, const char_T *c5_identifier);
static uint8_T c5_g_emlrt_marshallIn(SFc5_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sqrt(SFc5_F16_Real3InstanceStruct *chartInstance, real_T *c5_x);
static void init_dsm_address_info(SFc5_F16_Real3InstanceStruct *chartInstance);
...
static void initialize_c5_F16_Real3(SFc5_F16_Real3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real3 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_F16_Real3;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real3 = c5_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_F16_Real3");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_F16_Real3(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u[6];
  const mxArray *c5_y = NULL;
  SFc5_F16_Real3InstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real3InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_F16_Real3_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c5_b_is_active_c5_F16_Real3, const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_F16_Real3), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_F16_Real3);
  return c5_y;
}
...
void sf_c5_F16_Real3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1465576929U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1007325943U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2732298514U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2558473526U);
}

mxArray *sf_c5_F16_Real3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qVOTBQo3DujgD7FGrRt1Z");
...
mxArray *sf_c5_F16_Real3_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_F16_Real3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_F16_Real3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_F16_Real3_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_F16_Real3InstanceStruct *chartInstance;
    chartInstance = (SFc5_F16_Real3InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,599);
...
{
  return "bZYM41XxCtQcAIM9C9ntOG";
}

static void sf_opaque_initialize_c5_F16_Real3(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_F16_Real3InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*)
    chartInstanceVar);
  initialize_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_F16_Real3(void *chartInstanceVar)
{
  enable_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_F16_Real3(void *chartInstanceVar)
{
  disable_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_F16_Real3(void *chartInstanceVar)
{
  sf_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_F16_Real3(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_F16_Real3();/* state var info */
...
extern void sf_internal_set_sim_state_c5_F16_Real3(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_F16_Real3(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_F16_Real3(S);
}

static void sf_opaque_set_sim_state_c5_F16_Real3(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_F16_Real3(S, st);
}

static void sf_opaque_terminate_c5_F16_Real3(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_F16_Real3InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_F16_Real3_optimization_info();
    }

    finalize_c5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_F16_Real3((SFc5_F16_Real3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_F16_Real3(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_F16_Real3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2096319774U));
  ssSetChecksum1(S,(1627196305U));
  ssSetChecksum2(S,(2441419524U));
  ssSetChecksum3(S,(1429088372U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_F16_Real3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_F16_Real3(SimStruct *S)
{
  SFc5_F16_Real3InstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real3InstanceStruct *)utMalloc(sizeof
    (SFc5_F16_Real3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_F16_Real3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_F16_Real3;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_F16_Real3;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_F16_Real3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_F16_Real3;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_F16_Real3;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_F16_Real3;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_F16_Real3;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_F16_Real3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_F16_Real3;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_F16_Real3;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_F16_Real3;
...
void c5_F16_Real3_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_F16_Real3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_F16_Real3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_F16_Real3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_F16_Real3_method_dispatcher.\n"
