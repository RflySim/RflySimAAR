...
#include <stddef.h>
#include "blas.h"
#include "F16_Real3_sfun.h"
#include "c2_F16_Real3.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "F16_Real3_sfun_debug_macros.h"
...
static void initialize_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance);
static void initialize_params_c2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static void enable_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance);
static void disable_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static void set_sim_state_c2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance);
static void sf_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance);
static void c2_chartstep_c2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static void initSimStructsc2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static void registerMessagesc2_F16_Real3(SFc2_F16_Real3InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c2_Fz, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[30]);
static real_T c2_mpower(SFc2_F16_Real3InstanceStruct *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_F16_Real3InstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_F16_Real3InstanceStruct *chartInstance, real_T c2_x);
static void c2_eml_error(SFc2_F16_Real3InstanceStruct *chartInstance);
static real_T c2_abs(SFc2_F16_Real3InstanceStruct *chartInstance, real_T c2_x);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_F16_Real3, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_F16_Real3InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_F16_Real3InstanceStruct *chartInstance, real_T *c2_x);
static void init_dsm_address_info(SFc2_F16_Real3InstanceStruct *chartInstance);
...
static void initialize_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_F16_Real3 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_F16_Real3;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "Fz");
  chartInstance->c2_is_active_c2_F16_Real3 = c2_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "is_active_c2_F16_Real3");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_F16_Real3(chartInstance);
...
static void sf_c2_F16_Real3(SFc2_F16_Real3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_F16_Real3(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_F16_Real3MachineNumber_,
  ...
  *chartInstance)
{
  ...
  c2_bc_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  ...
  if (CV_EML_IF(0, 1, 0, c2_x <= c2_xc)) {
    ...
    if (CV_EML_IF(0, 1, 1, c2_x <= c2_xc + 2.0)) {
      ...
      c2_e_x = c2_d_x;
      c2_c_y = c2_e_x / 0.85;
      c2_d1 = (c2_c_y + c2_mpower(chartInstance, c2_y - c2_yc)) + c2_mpower
      ...
      c2_e_b = c2_abs(chartInstance, c2_abs(chartInstance, c2_h_y) -
                      0.22664539494376879);
      c2_i_y = -5.0 * c2_e_b;
      c2_j_x = c2_i_y;
      c2_k_x = c2_j_x;
      ...
      c2_f_b = c2_k_x;
      c2_j_y = 5.8630045941210422 * c2_f_b;
      c2_c_A = c2_mpower(chartInstance, c2_x - c2_xr);
      c2_l_x = c2_c_A;
      c2_m_x = c2_l_x;
      c2_k_y = c2_m_x / 2.0;
      c2_d2 = (c2_k_y + c2_mpower(chartInstance, c2_y - c2_yr)) + c2_mpower
        (chartInstance, c2_z - c2_zc);
      ...
      c2_q_x = c2_p_x;
      c2_n_y = c2_q_x / 0.85;
      c2_d3 = (c2_n_y + c2_mpower(chartInstance, c2_y - c2_yc)) + c2_mpower
        (chartInstance, c2_z - c2_zc);
      ...
      c2_u_x = c2_t_x;
      c2_r_y = c2_q_y;
      c2_s_y = c2_u_x / c2_r_y;
      c2_k_b = c2_abs(chartInstance, c2_abs(chartInstance, c2_s_y) -
                      0.22664539494376879);
      c2_t_y = -5.0 * c2_k_b;
      c2_v_x = c2_t_y;
      c2_w_x = c2_v_x;
      ...
      c2_l_b = c2_w_x;
      c2_u_y = 5.8630045941210422 * c2_l_b;
      c2_f_A = c2_mpower(chartInstance, c2_x - c2_xr);
      c2_x_x = c2_f_A;
      c2_y_x = c2_x_x;
      c2_v_y = c2_y_x / 2.0;
      c2_ab_x = (c2_v_y + c2_mpower(chartInstance, c2_y - c2_yr)) + c2_mpower
        (chartInstance, c2_z - c2_zc);
      c2_bb_x = c2_ab_x;
      if (c2_bb_x < 0.0) {
      ...
      c2_n_b = c2_db_x;
      c2_x_y = 120.0 * c2_n_b;
      c2_Fx = (c2_p_y + c2_u_y) - c2_x_y;
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 50);
      c2_eb_x = c2_Fx;
      c2_fb_x = c2_eb_x;
      c2_y_y = muDoubleScalarAbs(c2_fb_x);
      if (CV_EML_IF(0, 1, 2, c2_y_y > 100.0)) {
  ...
  c2_fc_x = c2_r;
  c2_gc_x = c2_fc_x;
  c2_nb_y = muDoubleScalarAbs(c2_gc_x);
  if (CV_EML_IF(0, 1, 5, c2_nb_y < 0.0001)) {
    ...
    c2_oc_x = c2_nc_x;
    c2_sb_y = muDoubleScalarAbs(c2_oc_x);
    c2_b_a = c2_rb_y;
    c2_u_b = c2_sb_y;
    c2_tb_y = c2_b_a * c2_u_b;
    c2_pc_x = c2_tb_y;
    c2_qc_x = c2_pc_x;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_F16_Real3InstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real3InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_F16_Real3_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_F16_Real3, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_F16_Real3), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_F16_Real3);
  return c2_y;
}
...
void sf_c2_F16_Real3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2203367571U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2925848949U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(562151145U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2112424088U);
}

mxArray *sf_c2_F16_Real3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("M6YS3RCZzriDBSwv1kLnND");
...
mxArray *sf_c2_F16_Real3_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_F16_Real3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_F16_Real3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_F16_Real3_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_F16_Real3InstanceStruct *chartInstance;
    chartInstance = (SFc2_F16_Real3InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_F16_Real3MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_F16_Real3MachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2112);
        _SFD_CV_INIT_EML_IF(0,1,0,1061,1069,1137,1592);
        _SFD_CV_INIT_EML_IF(0,1,1,1137,1151,1343,1592);
        _SFD_CV_INIT_EML_IF(0,1,2,1541,1555,-1,1588);
        _SFD_CV_INIT_EML_IF(0,1,3,1775,1788,1818,1859);
        _SFD_CV_INIT_EML_IF(0,1,4,1891,1898,1922,1956);
        _SFD_CV_INIT_EML_IF(0,1,5,1958,1974,1995,2111);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _F16_Real3MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "04hwgis6p9BL8xkjmqpZS";
}

static void sf_opaque_initialize_c2_F16_Real3(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_F16_Real3InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*)
    chartInstanceVar);
  initialize_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_F16_Real3(void *chartInstanceVar)
{
  enable_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_F16_Real3(void *chartInstanceVar)
{
  disable_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_F16_Real3(void *chartInstanceVar)
{
  sf_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_F16_Real3(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_F16_Real3();/* state var info */
...
extern void sf_internal_set_sim_state_c2_F16_Real3(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_F16_Real3(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_F16_Real3(S);
}

static void sf_opaque_set_sim_state_c2_F16_Real3(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_F16_Real3(S, st);
}

static void sf_opaque_terminate_c2_F16_Real3(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_F16_Real3InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_F16_Real3_optimization_info();
    }

    finalize_c2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_F16_Real3((SFc2_F16_Real3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_F16_Real3(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_F16_Real3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_F16_Real3_optimization_info();
  ...
  ssSetChecksum0(S,(1804135150U));
  ssSetChecksum1(S,(2285166924U));
  ssSetChecksum2(S,(1276754353U));
  ssSetChecksum3(S,(3748993942U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_F16_Real3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_F16_Real3(SimStruct *S)
{
  SFc2_F16_Real3InstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real3InstanceStruct *)utMalloc(sizeof
    (SFc2_F16_Real3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_F16_Real3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_F16_Real3;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_F16_Real3;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_F16_Real3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_F16_Real3;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_F16_Real3;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_F16_Real3;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_F16_Real3;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_F16_Real3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_F16_Real3;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_F16_Real3;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_F16_Real3;
...
void c2_F16_Real3_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_F16_Real3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_F16_Real3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_F16_Real3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_F16_Real3_method_dispatcher.\n"
