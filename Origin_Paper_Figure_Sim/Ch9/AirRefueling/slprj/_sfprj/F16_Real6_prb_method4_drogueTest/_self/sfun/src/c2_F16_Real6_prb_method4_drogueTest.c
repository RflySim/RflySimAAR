...
#include "c2_F16_Real6_prb_method4_drogueTest.h"
...
static void initialize_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void initialize_params_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void enable_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void disable_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void set_sim_state_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void sf_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void c2_chartstep_c2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void initSimStructsc2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
static void registerMessagesc2_F16_Real6_prb_method4_drogueTest
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance);
...
static real_T c2_mpower(SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct
  *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_F16_Real6_prb_method4_drogueTest, const char_T
   *c2_identifier);
  ...
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_F16_Real6_prb_method4_drogueTest = 0U;
}
  ...
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_F16_Real6_prb_method4_drogueTest;
   ...
   mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_F16_Real6_prb_method4_drogueTest =
    ...
    "is_active_c2_F16_Real6_prb_method4_drogueTest");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_F16_Real6_prb_method4_drogueTest(chartInstance);
  ...
  (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_F16_Real6_prb_method4_drogueTest(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_F16_Real6_prb_method4_drogueTest_get_eml_resolved_functions_info(void)
{
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_F16_Real6_prb_method4_drogueTest), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_F16_Real6_prb_method4_drogueTest);
  return c2_y;
}
...
void sf_c2_F16_Real6_prb_method4_drogueTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_F16_Real6_prb_method4_drogueTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_F16_Real6_prb_method4_drogueTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_F16_Real6_prb_method4_drogueTest
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_F16_Real6_prb_method4_drogueTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_F16_Real6_prb_method4_drogueTest_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_F16_Real6_prb_method4_drogueTest(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
  initialize_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_F16_Real6_prb_method4_drogueTest(void
  *chartInstanceVar)
{
  enable_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_F16_Real6_prb_method4_drogueTest(void
  *chartInstanceVar)
{
  disable_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_F16_Real6_prb_method4_drogueTest(void
  *chartInstanceVar)
{
  sf_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_F16_Real6_prb_method4_drogueTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_F16_Real6_prb_method4_drogueTest
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c2_F16_Real6_prb_method4_drogueTest
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_F16_Real6_prb_method4_drogueTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_F16_Real6_prb_method4_drogueTest(S);
}

static void sf_opaque_set_sim_state_c2_F16_Real6_prb_method4_drogueTest
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_F16_Real6_prb_method4_drogueTest(S, st);
}

static void sf_opaque_terminate_c2_F16_Real6_prb_method4_drogueTest(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_F16_Real6_prb_method4_drogueTest
      ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_F16_Real6_prb_method4_drogueTest
    ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_F16_Real6_prb_method4_drogueTest(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_F16_Real6_prb_method4_drogueTest
      ((SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_F16_Real6_prb_method4_drogueTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_F16_Real6_prb_method4_drogueTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_F16_Real6_prb_method4_drogueTest(SimStruct *S)
{
  SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct *)
    utMalloc(sizeof(SFc2_F16_Real6_prb_method4_drogueTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_F16_Real6_prb_method4_drogueTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_F16_Real6_prb_method4_drogueTest;
...
void c2_F16_Real6_prb_method4_drogueTest_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_F16_Real6_prb_method4_drogueTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_F16_Real6_prb_method4_drogueTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_F16_Real6_prb_method4_drogueTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_F16_Real6_prb_method4_drogueTest_method_dispatcher.\n"
