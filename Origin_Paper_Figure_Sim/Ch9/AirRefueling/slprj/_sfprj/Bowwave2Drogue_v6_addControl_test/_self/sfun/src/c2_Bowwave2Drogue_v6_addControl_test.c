...
static void initialize_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void initialize_params_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void enable_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void disable_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void set_sim_state_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void sf_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void c2_chartstep_c2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void initSimStructsc2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void registerMessagesc2_Bowwave2Drogue_v6_addControl_test
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance, const
   mxArray *c2_Fz, const char_T *c2_identifier);
...
static real_T c2_mpower(SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_test, const char_T
   *c2_identifier);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_test = 0U;
}
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_test;
   ...
   mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_test =
    ...
    "is_active_c2_Bowwave2Drogue_v6_addControl_test");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Bowwave2Drogue_v6_addControl_test(chartInstance);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Bowwave2Drogue_v6_addControl_test(chartInstance);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  c2_hb_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_Fx = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_wb_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_wb_x;
  c2_b_hoistedGlobal = *c2_hb_y;
  ...
  guard2 = FALSE;
  guard3 = FALSE;
  if (CV_EML_COND(0, 1, 0, c2_x < 0.0)) {
    guard3 = TRUE;
  } else {
    c2_qb_x = c2_x;
    c2_rb_x = c2_qb_x;
    c2_eb_y = muDoubleScalarAbs(c2_rb_x);
    if (CV_EML_COND(0, 1, 1, c2_eb_y > 4.6274872744099955)) {
      guard3 = TRUE;
    } else {
      c2_sb_x = c2_y;
      c2_tb_x = c2_sb_x;
      c2_fb_y = muDoubleScalarAbs(c2_tb_x);
      if (CV_EML_COND(0, 1, 2, c2_fb_y > 1.0)) {
        guard2 = TRUE;
      } else {
        c2_ub_x = c2_z;
        c2_vb_x = c2_ub_x;
        c2_gb_y = muDoubleScalarAbs(c2_vb_x);
        if (CV_EML_COND(0, 1, 3, c2_gb_y > 1.0)) {
          guard1 = TRUE;
        } else {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *)
    chartInstanceVoid;
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[20])
{
  ...
  c2_info[18].fileTimeLo = 1343808766U;
  ...
  c2_info[19].fileTimeLo = 1286797112U;
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_test), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_test);
  return c2_y;
}
...
void sf_c2_Bowwave2Drogue_v6_addControl_test_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4011811550U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(621448696U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2475245037U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(836653053U);
}

mxArray *sf_c2_Bowwave2Drogue_v6_addControl_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ZdVf5UCzI6N6SmdtdHnqTF");
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_test
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_Bowwave2Drogue_v6_addControl_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Bowwave2Drogue_v6_addControl_test_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,1,5,0,0,0,0,0,4,1);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1016);
        _SFD_CV_INIT_EML_IF(0,1,0,435,450,463,535);
        _SFD_CV_INIT_EML_IF(0,1,1,537,552,565,641);
        _SFD_CV_INIT_EML_IF(0,1,2,643,671,684,936);
        _SFD_CV_INIT_EML_IF(0,1,3,684,703,778,936);
        _SFD_CV_INIT_EML_IF(0,1,4,938,982,-1,1016);

        {
          static int condStart[] = { 941, 947, 964, 974 };

          static int condEnd[] = { 944, 962, 972, 982 };

          static int pfixExpr[] = { 0, 1, -2, 2, -2, 3, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,941,982,4,0,&(condStart[0]),&(condEnd[0]),
                                7,&(pfixExpr[0]));
        }
...
{
  return "7giJ3lfmd38m98AvuPOF1D";
}

static void sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
  initialize_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  enable_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  disable_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  sf_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_test();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_test
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_test(S);
}

static void sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_test
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_test(S, st);
}

static void sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_Bowwave2Drogue_v6_addControl_test
      ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_Bowwave2Drogue_v6_addControl_test
    ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_test(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_Bowwave2Drogue_v6_addControl_test
      ((SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(2730653992U));
  ssSetChecksum1(S,(163077936U));
  ssSetChecksum2(S,(3227533827U));
  ssSetChecksum3(S,(611902717U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct *)
    utMalloc(sizeof(SFc2_Bowwave2Drogue_v6_addControl_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_test;
...
void c2_Bowwave2Drogue_v6_addControl_test_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Bowwave2Drogue_v6_addControl_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Bowwave2Drogue_v6_addControl_test_method_dispatcher.\n"
