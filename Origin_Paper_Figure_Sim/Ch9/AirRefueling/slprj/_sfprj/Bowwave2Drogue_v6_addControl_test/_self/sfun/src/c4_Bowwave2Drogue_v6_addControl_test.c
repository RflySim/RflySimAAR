...
static const char * c4_debug_family_names[18] = { "Ve", "rho", "Q", "S", "CD",
  "uu", "vv", "ww", "beta", "theta", "C_beta", "yx", "yy", "yz", "nargin",
  "nargout", "u", "y" };

/* Function Declarations */
static void initialize_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void initialize_params_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void enable_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void disable_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void set_sim_state_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance, const
   mxArray *c4_st);
static void finalize_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void sf_c4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void initSimStructsc4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void registerMessagesc4_Bowwave2Drogue_v6_addControl_test
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
...
static real_T c4_mpower(SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct
  *chartInstance, real_T c4_a);
static void c4_eml_scalar_eg
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance);
static void c4_eml_error(SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct
  *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance, const
   mxArray *c4_b_is_active_c4_Bowwave2Drogue_v6_addControl_test, const char_T
   *c4_identifier);
  ...
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Bowwave2Drogue_v6_addControl_test = 0U;
}
  ...
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal =
    chartInstance->c4_is_active_c4_Bowwave2Drogue_v6_addControl_test;
   ...
   mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_Bowwave2Drogue_v6_addControl_test =
    ...
    "is_active_c4_Bowwave2Drogue_v6_addControl_test");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Bowwave2Drogue_v6_addControl_test(chartInstance);
  ...
  (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_i_y)[3];
  real_T (*c4_b_u)[3];
  c4_i_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c4_i3 = 0; c4_i3 < 3; c4_i3++) {
    _SFD_DATA_RANGE_CHECK((*c4_i_y)[c4_i3], 1U);
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_ww, 7U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_beta, 8U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_theta, 9U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_C_beta, 10U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_yx, 11U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_yy, 12U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_yz, 13U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 15U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_u, 16U, c4_sf_marshallOut);
  ...
  c4_x = c4_mpower(chartInstance, c4_vv) + c4_mpower(chartInstance, c4_ww);
  c4_b_x = c4_x;
  if (c4_b_x < 0.0) {
  ...
  c4_f_x = c4_e_x;
  c4_e_y = c4_d_y;
  c4_f_y = c4_f_x / c4_e_y;
  c4_g_x = c4_f_y;
  c4_theta = c4_g_x;
  c4_h_x = c4_theta;
  c4_theta = c4_h_x;
  c4_theta = muDoubleScalarAtan(c4_theta);
  ...
  c4_b_b = c4_vv;
  c4_g_y = 666.80081999999993 * c4_b_b;
  c4_c_A = c4_g_y;
  c4_i_x = c4_c_A;
  c4_j_x = c4_i_x;
  c4_yy = c4_j_x / 120.0;
  ...
  c4_c_b = c4_ww;
  c4_h_y = 666.80081999999993 * c4_c_b;
  c4_d_A = c4_h_y;
  c4_k_x = c4_d_A;
  c4_l_x = c4_k_x;
  c4_yz = c4_l_x / 120.0;
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance;
  chartInstance = (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c4_Bowwave2Drogue_v6_addControl_test_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[18])
{
  ...
  c4_info[9].fileTimeLo = 1343808786U;
  ...
  c4_info[10].fileTimeLo = 1343808758U;
  ...
  c4_info[11].fileTimeLo = 1286797138U;
  ...
  c4_info[12].fileTimeLo = 1357926348U;
  c4_info[12].fileTimeHi = 0U;
  c4_info[12].mFileTimeLo = 1319708366U;
  ...
  c4_info[13].fileTimeLo = 1346488788U;
  ...
  c4_info[14].fileTimeLo = 1286797196U;
   ...
   *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Bowwave2Drogue_v6_addControl_test), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Bowwave2Drogue_v6_addControl_test);
  return c4_y;
}
...
void sf_c4_Bowwave2Drogue_v6_addControl_test_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1156021070U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1960500302U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1300823824U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1484096075U);
}

mxArray *sf_c4_Bowwave2Drogue_v6_addControl_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yq6F6BUgUFvJxJT58o9KZH");
...
mxArray *sf_c4_Bowwave2Drogue_v6_addControl_test_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c4_Bowwave2Drogue_v6_addControl_test
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_Bowwave2Drogue_v6_addControl_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Bowwave2Drogue_v6_addControl_test_get_check_sum(&mxChecksum);
...
{
  return "OHtJbEkcShZoJL45Obz8lE";
}

static void sf_opaque_initialize_c4_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
  initialize_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  enable_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  disable_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  sf_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_Bowwave2Drogue_v6_addControl_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c4_Bowwave2Drogue_v6_addControl_test();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Bowwave2Drogue_v6_addControl_test
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_Bowwave2Drogue_v6_addControl_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_Bowwave2Drogue_v6_addControl_test(S);
}

static void sf_opaque_set_sim_state_c4_Bowwave2Drogue_v6_addControl_test
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Bowwave2Drogue_v6_addControl_test(S, st);
}

static void sf_opaque_terminate_c4_Bowwave2Drogue_v6_addControl_test(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c4_Bowwave2Drogue_v6_addControl_test
      ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_Bowwave2Drogue_v6_addControl_test
    ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Bowwave2Drogue_v6_addControl_test(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_Bowwave2Drogue_v6_addControl_test
      ((SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(4227875970U));
  ssSetChecksum1(S,(1024856155U));
  ssSetChecksum2(S,(844630686U));
  ssSetChecksum3(S,(4225322984U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Bowwave2Drogue_v6_addControl_test(SimStruct *S)
{
  SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *chartInstance;
  chartInstance = (SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct *)
    utMalloc(sizeof(SFc4_Bowwave2Drogue_v6_addControl_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_Bowwave2Drogue_v6_addControl_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Bowwave2Drogue_v6_addControl_test;
...
void c4_Bowwave2Drogue_v6_addControl_test_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Bowwave2Drogue_v6_addControl_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Bowwave2Drogue_v6_addControl_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Bowwave2Drogue_v6_addControl_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Bowwave2Drogue_v6_addControl_test_method_dispatcher.\n"
