...
static void initialize_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance);
static void initialize_params_c6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance);
static void enable_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance);
static void disable_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance);
static void set_sim_state_c6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance);
static void sf_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance);
static void initSimStructsc6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance);
static void registerMessagesc6_F16_Real4(SFc6_F16_Real4InstanceStruct
  *chartInstance);
static void c6_TankerVortexWindField(SFc6_F16_Real4InstanceStruct *chartInstance,
  real_T c6_PosReceiver[3], real_T c6_y[3]);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
  const mxArray *c6_TkTur2dr, const char_T *c6_identifier, real_T c6_y[3]);
static void c6_b_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[3]);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
...
static real_T c6_mpower(SFc6_F16_Real4InstanceStruct *chartInstance, real_T c6_a);
static void c6_eml_scalar_eg(SFc6_F16_Real4InstanceStruct *chartInstance);
static real_T c6_sqrt(SFc6_F16_Real4InstanceStruct *chartInstance, real_T c6_x);
static void c6_eml_error(SFc6_F16_Real4InstanceStruct *chartInstance);
static real_T c6_abs(SFc6_F16_Real4InstanceStruct *chartInstance, real_T c6_x);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_F16_Real4, const char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_F16_Real4InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sqrt(SFc6_F16_Real4InstanceStruct *chartInstance, real_T *c6_x);
static void init_dsm_address_info(SFc6_F16_Real4InstanceStruct *chartInstance);
...
static void initialize_c6_F16_Real4(SFc6_F16_Real4InstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_F16_Real4 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_F16_Real4;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_F16_Real4 = c6_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_F16_Real4");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_F16_Real4(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u[3];
  const mxArray *c6_y = NULL;
  SFc6_F16_Real4InstanceStruct *chartInstance;
  chartInstance = (SFc6_F16_Real4InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_F16_Real4_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c6_b_is_active_c6_F16_Real4, const char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_F16_Real4), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_F16_Real4);
  return c6_y;
}
...
void sf_c6_F16_Real4_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_F16_Real4_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_F16_Real4_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_F16_Real4(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"TkTur2dr\",},{M[8],M[0],T\"is_active_c6_F16_Real4\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_F16_Real4_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_F16_Real4InstanceStruct *chartInstance;
    chartInstance = (SFc6_F16_Real4InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_F16_Real4(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_F16_Real4InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*)
    chartInstanceVar);
  initialize_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_F16_Real4(void *chartInstanceVar)
{
  enable_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_F16_Real4(void *chartInstanceVar)
{
  disable_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_F16_Real4(void *chartInstanceVar)
{
  sf_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_F16_Real4(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_F16_Real4();/* state var info */
...
extern void sf_internal_set_sim_state_c6_F16_Real4(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_F16_Real4(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_F16_Real4(S);
}

static void sf_opaque_set_sim_state_c6_F16_Real4(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_F16_Real4(S, st);
}

static void sf_opaque_terminate_c6_F16_Real4(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_F16_Real4InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_F16_Real4_optimization_info();
    }

    finalize_c6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_F16_Real4((SFc6_F16_Real4InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_F16_Real4(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_F16_Real4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_F16_Real4(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_F16_Real4(SimStruct *S)
{
  SFc6_F16_Real4InstanceStruct *chartInstance;
  chartInstance = (SFc6_F16_Real4InstanceStruct *)utMalloc(sizeof
    (SFc6_F16_Real4InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_F16_Real4InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_F16_Real4;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_F16_Real4;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_F16_Real4;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_F16_Real4;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_F16_Real4;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_F16_Real4;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_F16_Real4;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_F16_Real4;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_F16_Real4;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_F16_Real4;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_F16_Real4;
...
void c6_F16_Real4_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_F16_Real4(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_F16_Real4(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_F16_Real4(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_F16_Real4_method_dispatcher.\n"
