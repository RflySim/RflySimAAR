...
static void initialize_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void initialize_params_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void enable_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void disable_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_F16_Real5_nn
  (SFc5_F16_Real5_nnInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_F16_Real5_nn
  (SFc5_F16_Real5_nnInstanceStruct *chartInstance);
static void set_sim_state_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void sf_c5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct *chartInstance);
static void initSimStructsc5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void registerMessagesc5_F16_Real5_nn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance);
static void c5_TankerVortexWindField(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, real_T c5_PosReceiver[3], real_T c5_y[3]);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct *chartInstance,
  const mxArray *c5_y, const char_T *c5_identifier, real_T c5_b_y[6]);
static void c5_b_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct *chartInstance,
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_d_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct *chartInstance,
...
static real_T c5_mpower(SFc5_F16_Real5_nnInstanceStruct *chartInstance, real_T
  c5_a);
static void c5_eml_scalar_eg(SFc5_F16_Real5_nnInstanceStruct *chartInstance);
static real_T c5_sqrt(SFc5_F16_Real5_nnInstanceStruct *chartInstance, real_T
                      c5_x);
static void c5_eml_error(SFc5_F16_Real5_nnInstanceStruct *chartInstance);
static real_T c5_abs(SFc5_F16_Real5_nnInstanceStruct *chartInstance, real_T c5_x);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_e_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_f_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_F16_Real5_nn, const char_T
  *c5_identifier);
static uint8_T c5_g_emlrt_marshallIn(SFc5_F16_Real5_nnInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sqrt(SFc5_F16_Real5_nnInstanceStruct *chartInstance, real_T
                      *c5_x);
static void init_dsm_address_info(SFc5_F16_Real5_nnInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real5_nn = 0U;
}
  ...
  (SFc5_F16_Real5_nnInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_F16_Real5_nn;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_F16_Real5_nn = c5_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_F16_Real5_nn");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_F16_Real5_nn(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_F16_Real5_nnInstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real5_nnInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_F16_Real5_nn_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_F16_Real5_nn), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_F16_Real5_nn);
  return c5_y;
}
...
void sf_c5_F16_Real5_nn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_F16_Real5_nn_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_F16_Real5_nn_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_F16_Real5_nn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_F16_Real5_nn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_F16_Real5_nn_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_F16_Real5_nnInstanceStruct *chartInstance;
    chartInstance = (SFc5_F16_Real5_nnInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_F16_Real5_nn(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_F16_Real5_nnInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*)
    chartInstanceVar);
  initialize_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_F16_Real5_nn(void *chartInstanceVar)
{
  enable_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_F16_Real5_nn(void *chartInstanceVar)
{
  disable_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_F16_Real5_nn(void *chartInstanceVar)
{
  sf_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_F16_Real5_nn(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_F16_Real5_nn
    ((SFc5_F16_Real5_nnInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_F16_Real5_nn();/* state var info */
...
extern void sf_internal_set_sim_state_c5_F16_Real5_nn(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_F16_Real5_nn(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_F16_Real5_nn(S);
}

static void sf_opaque_set_sim_state_c5_F16_Real5_nn(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c5_F16_Real5_nn(S, st);
}

static void sf_opaque_terminate_c5_F16_Real5_nn(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_F16_Real5_nn_optimization_info();
    }

    finalize_c5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_F16_Real5_nn((SFc5_F16_Real5_nnInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_F16_Real5_nn(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_F16_Real5_nn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_F16_Real5_nn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_F16_Real5_nn(SimStruct *S)
{
  SFc5_F16_Real5_nnInstanceStruct *chartInstance;
  chartInstance = (SFc5_F16_Real5_nnInstanceStruct *)utMalloc(sizeof
    (SFc5_F16_Real5_nnInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_F16_Real5_nnInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_F16_Real5_nn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_F16_Real5_nn;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_F16_Real5_nn;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_F16_Real5_nn;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_F16_Real5_nn;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_F16_Real5_nn;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_F16_Real5_nn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_F16_Real5_nn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_F16_Real5_nn;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_F16_Real5_nn;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_F16_Real5_nn;
...
void c5_F16_Real5_nn_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_F16_Real5_nn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_F16_Real5_nn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_F16_Real5_nn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_F16_Real5_nn_method_dispatcher.\n"
