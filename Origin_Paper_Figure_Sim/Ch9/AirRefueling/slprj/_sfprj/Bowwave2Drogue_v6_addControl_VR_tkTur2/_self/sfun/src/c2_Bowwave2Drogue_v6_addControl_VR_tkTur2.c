...
#include "c2_Bowwave2Drogue_v6_addControl_VR_tkTur2.h"
...
static void initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c2_st);
static void finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void registerMessagesc2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
...
static void c2_eml_scalar_eg
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *
                      chartInstance, real_T c2_x);
static void c2_eml_error
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static real_T c2_abs(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct
                     *chartInstance, real_T c2_x);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2,
   const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *
                      chartInstance, real_T *c2_x);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2 = 0U;
}
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
   ...
   const mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2 =
    ...
    "is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2");
  sf_mex_destroy(&c2_u);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2);
  return c2_y;
}
...
void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
  initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
}

static void sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(S, st);
}

static void sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
      ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct *S)
{
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *)
    utMalloc(sizeof(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2;
...
void c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_method_dispatcher.\n"
