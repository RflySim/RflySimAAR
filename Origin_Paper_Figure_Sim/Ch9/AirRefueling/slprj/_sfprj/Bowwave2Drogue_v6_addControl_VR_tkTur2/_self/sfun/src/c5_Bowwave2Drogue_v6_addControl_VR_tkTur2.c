...
#include "c5_Bowwave2Drogue_v6_addControl_VR_tkTur2.h"
...
static void initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c5_st);
static void finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static void registerMessagesc5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
...
static void c5_eml_scalar_eg
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static real_T c5_sqrt(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *
                      chartInstance, real_T c5_x);
static void c5_eml_error
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance);
static real_T c5_abs(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct
                     *chartInstance, real_T c5_x);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2,
   const char_T *c5_identifier);
static uint8_T c5_g_emlrt_marshallIn
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance,
   const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sqrt(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *
                      chartInstance, real_T *c5_x);
  ...
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2 = 0U;
}
  ...
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal =
    chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
   ...
   const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2 =
    ...
    "is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2");
  sf_mex_destroy(&c5_u);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance;
  chartInstance = (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2);
  return c5_y;
}
...
void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(639069892U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3420877926U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2819370359U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1660391366U);
}

mxArray *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QIINz6X7xEOe5kg7qkTAK");
...
mxArray *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,554);
...
{
  return "pPJbjlNhohqfVtWBbuNMBB";
}

static void sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void *
  chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
  initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
}

static void sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(S, st);
}

static void sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
      ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(1469341495U));
  ssSetChecksum1(S,(246034873U));
  ssSetChecksum2(S,(4145233865U));
  ssSetChecksum3(S,(1096455195U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(SimStruct *S)
{
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *chartInstance;
  chartInstance = (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct *)
    utMalloc(sizeof(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2;
...
void c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_method_dispatcher.\n"
