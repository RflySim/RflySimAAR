...
#include "c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003.h"
...
static void initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
...
static const mxArray
  *get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance, const mxArray *c3_st);
static void finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void registerMessagesc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
...
static uint8_T c3_k_emlrt_marshallIn
   ...
   *c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200, const
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    = 0U;
}
   ...
   *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ...
    "is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003");
  sf_mex_destroy(&c3_u);
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(chartInstance);
...
const mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c3_identifier)
{
  ...
  c3_y = c3_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200),
    &c3_thisId);
  sf_mex_destroy
    (&c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200);
  return c3_y;
...
void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_autoinheritance_info
  (void)
{
...
mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"y\",},{M[8],M[0],T\"is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_check_sum
    (&mxChecksum);
...
static void
  sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
  initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003();/* state var info */
...
extern void
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
...
static void
  sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S,
    st);
}

static void
  sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
      ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
...
void c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_method_dispatcher.\n"
