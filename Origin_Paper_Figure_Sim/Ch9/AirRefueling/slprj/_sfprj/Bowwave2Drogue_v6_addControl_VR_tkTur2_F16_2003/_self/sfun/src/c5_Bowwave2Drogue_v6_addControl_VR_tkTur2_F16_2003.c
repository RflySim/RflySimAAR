...
#include "c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003.h"
...
static void initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
...
static const mxArray
  *get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance, const mxArray *c5_st);
static void finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
static void registerMessagesc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
   *chartInstance);
...
static uint8_T c5_f_emlrt_marshallIn
   ...
   *c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200, const
   ...
   *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    = 0U;
}
   ...
   *chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ...
    "is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003");
  sf_mex_destroy(&c5_u);
...
const mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200),
    &c5_thisId);
  sf_mex_destroy
    (&c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_200);
  return c5_y;
...
void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_check_sum(mxArray
  *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(647740016U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1936748636U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1091718015U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3996607623U);
}

mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("jzH8COS8iRiudeBo4Wjr3F");
...
mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_get_check_sum
    (&mxChecksum);
...
{
  return "Gd0G3diWILAN4gV8DMqfWE";
}

static void
  sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
  initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (void *chartInstanceVar)
{
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003();/* state var info */
...
extern void
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
...
static void
  sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S,
    st);
}

static void
  sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
      ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(345691622U));
  ssSetChecksum1(S,(2512430779U));
  ssSetChecksum2(S,(3658518058U));
  ssSetChecksum3(S,(2674352725U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003
  (SimStruct *S)
{
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003InstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003;
...
void c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_2003_method_dispatcher.\n"
