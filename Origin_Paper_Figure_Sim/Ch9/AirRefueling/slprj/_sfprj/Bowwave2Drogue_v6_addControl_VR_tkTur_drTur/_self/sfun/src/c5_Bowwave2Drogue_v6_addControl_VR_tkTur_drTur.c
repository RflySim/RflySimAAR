...
#include "c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur.h"
...
static void initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance,
   const mxArray *c5_st);
static void finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void registerMessagesc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance,
   const mxArray *c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur,
  ...
  (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur =
    0U;
}
   ...
   const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur =
    ...
    "is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur");
  sf_mex_destroy(&c5_u);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance;
  chartInstance =
    (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur);
  return c5_y;
}
...
void sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
  initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(void
  *chartInstanceVar)
{
  enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  sf_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur();/* state var info */
...
extern void
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
}

static void
  sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S, st);
}

static void sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
      ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(SimStruct *S)
{
  SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance;
  chartInstance =
    (SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *)utMalloc
    (sizeof(SFc5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
...
void c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_method_dispatcher.\n"
