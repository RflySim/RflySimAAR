...
#include "c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur.h"
...
static void initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance,
   const mxArray *c2_st);
static void finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
static void registerMessagesc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance,
   const mxArray *c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur,
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur =
    0U;
}
   ...
   const mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur =
    ...
    "is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur");
  sf_mex_destroy(&c2_u);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(chartInstance);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance)
{
  ...
  c2_ec_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_Fx = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_ed_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_ed_x;
  c2_b_hoistedGlobal = *c2_ec_y;
  ...
  if (CV_EML_IF(0, 1, 0, c2_x <= c2_xc)) {
    ...
    if (CV_EML_IF(0, 1, 1, c2_x <= c2_xc + 2.0)) {
      ...
      c2_q_x = c2_p_x;
      c2_o_y = c2_q_x / 0.85;
      c2_r_x = (c2_o_y + c2_mpower(chartInstance, c2_y - c2_yc)) + c2_mpower
        (chartInstance, c2_z - c2_zc);
      c2_s_x = c2_r_x;
      if (c2_s_x < 0.0) {
      ...
      c2_j_b = c2_u_x;
      c2_q_y = 120.0 * c2_j_b;
      c2_v_x = c2_mpower(chartInstance, c2_y) + c2_mpower(chartInstance, c2_z);
      c2_w_x = c2_v_x;
      if (c2_w_x < 0.0) {
        c2_eml_error(chartInstance);
      }
      ...
      c2_y_x = c2_x_x;
      c2_s_y = c2_r_y;
      c2_t_y = c2_y_x / c2_s_y;
      c2_ab_x = c2_t_y;
      c2_bb_x = c2_ab_x;
      c2_u_y = muDoubleScalarAbs(c2_bb_x);
      c2_cb_x = c2_u_y - 0.22664539494376879;
      c2_db_x = c2_cb_x;
      c2_v_y = muDoubleScalarAbs(c2_db_x);
      c2_k_b = c2_v_y;
      c2_w_y = -5.0 * c2_k_b;
      c2_eb_x = c2_w_y;
      c2_fb_x = c2_eb_x;
      c2_fb_x = muDoubleScalarExp(c2_fb_x);
      c2_l_b = c2_fb_x;
      c2_x_y = 5.8630045941210422 * c2_l_b;
      c2_f_A = c2_mpower(chartInstance, c2_x - c2_xr);
      c2_gb_x = c2_f_A;
      c2_hb_x = c2_gb_x;
      c2_y_y = c2_hb_x / 2.0;
      c2_ib_x = (c2_y_y + c2_mpower(chartInstance, c2_y - c2_yr)) + c2_mpower
        (chartInstance, c2_z - c2_zc);
      c2_jb_x = c2_ib_x;
      if (c2_jb_x < 0.0) {
        c2_eml_error(chartInstance);
      ...
      c2_jb_x = muDoubleScalarSqrt(c2_jb_x);
      c2_m_b = c2_jb_x + 1.1;
      c2_ab_y = -2.6 * c2_m_b;
      c2_kb_x = c2_ab_y;
      c2_lb_x = c2_kb_x;
      ...
      c2_n_b = c2_lb_x;
      c2_bb_y = 120.0 * c2_n_b;
      c2_Fx = ((c2_V0 - c2_q_y) + c2_x_y) - c2_bb_y;
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 50);
      c2_mb_x = c2_Fx;
      c2_nb_x = c2_mb_x;
      c2_cb_y = muDoubleScalarAbs(c2_nb_x);
      if (CV_EML_IF(0, 1, 2, c2_cb_y > 100.0)) {
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 51);
        c2_ob_x = c2_Fx;
        c2_pb_x = c2_ob_x;
        c2_pb_x = muDoubleScalarSign(c2_pb_x);
        c2_o_b = c2_pb_x;
        c2_Fx = 100.0 * c2_o_b;
      }
    }
  ...
  c2_qb_x = c2_mpower(chartInstance, c2_y - c2_yyc) + c2_mpower(chartInstance,
    c2_z);
  c2_r = c2_qb_x;
  if (c2_r < 0.0) {
    c2_eml_error(chartInstance);
  ...
  if (CV_EML_IF(0, 1, 3, c2_y - c2_yyc >= 0.0)) {
    ...
    c2_xb_x = c2_wb_x;
    c2_hb_y = c2_gb_y;
    c2_ib_y = c2_xb_x / c2_hb_y;
    c2_yb_x = c2_ib_y;
    c2_ac_x = c2_yb_x;
    c2_ac_x = muDoubleScalarAtan(c2_ac_x);
    c2_beta1 = c2_ac_x + 3.1415926535897931;
  }
  ...
  if (CV_EML_IF(0, 1, 4, c2_x >= 0.0)) {
    ...
    c2_kc_x = c2_jc_x;
    c2_ob_y = c2_nb_y;
    c2_pb_y = c2_kc_x / c2_ob_y;
    c2_lc_x = c2_pb_y;
    c2_mc_x = c2_lc_x;
    c2_mc_x = muDoubleScalarAtan(c2_mc_x);
    c2_alpha = c2_mc_x + 3.1415926535897931;
  }
  ...
  if (CV_EML_IF(0, 1, 5, c2_qb_y < 0.0001)) {
    ...
    c2_t_b = 1.0 + c2_tb_y;
    c2_ub_y = -1.5 * c2_t_b;
    c2_vc_x = c2_alpha - c2_theta;
    c2_wc_x = c2_vc_x;
    c2_vb_y = muDoubleScalarAbs(c2_wc_x);
    c2_b_a = c2_ub_y;
    c2_u_b = c2_vb_y;
    c2_wb_y = c2_b_a * c2_u_b;
    c2_xc_x = c2_wb_y;
    c2_yc_x = c2_xc_x;
    c2_yc_x = muDoubleScalarExp(c2_yc_x);
    c2_c_a = c2_sb_y;
    c2_v_b = c2_yc_x;
    c2_f = c2_c_a * c2_v_b;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance;
  chartInstance =
    (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_eml_resolved_functions_info
  (void)
{
   ...
   const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur);
  return c2_y;
}
...
void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
  initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(void
  *chartInstanceVar)
{
  enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur();/* state var info */
...
extern void
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
}

static void
  sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S, st);
}

static void sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
      ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(SimStruct *S)
{
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *chartInstance;
  chartInstance =
    (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct *)utMalloc
    (sizeof(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur;
...
void c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Bowwave2Drogue_v6_addControl_VR_tkTur_drTur_method_dispatcher.\n"
