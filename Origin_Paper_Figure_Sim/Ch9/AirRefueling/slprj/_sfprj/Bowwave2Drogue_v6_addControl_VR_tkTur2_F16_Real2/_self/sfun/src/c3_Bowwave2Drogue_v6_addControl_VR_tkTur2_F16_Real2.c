...
#include <stddef.h>
#include "blas.h"
#include "Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_sfun.h"
#include "c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_sfun_debug_macros.h"
...
static void initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
...
static const mxArray
  *get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance, const mxArray *c3_st);
static void finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void registerMessagesc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
...
static uint8_T c3_k_emlrt_marshallIn
   ...
   *c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea, const
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    = 0U;
}
   ...
   *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ...
    "is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2");
  sf_mex_destroy(&c3_u);
   ...
   *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2MachineNumber_,
   ...
   *chartInstance)
{
  ...
  real_T c3_d8;
  int32_T c3_i38;
  static real_T c3_dv1[3] = { 0.0, -0.5, -0.7 };
   ...
   char_T *c3_identifier)
{
  ...
  c3_y = c3_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea),
    &c3_thisId);
  sf_mex_destroy
    (&c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea);
  return c3_y;
...
void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_check_sum
  (mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1227079460U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(67475436U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3300329055U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(847682895U);
}

mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("A9qFOuwkZAv9AsYpyFU87C");
...
mxArray
  *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"y\",},{M[8],M[0],T\"is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_check_sum
    (&mxChecksum);
...
{
  return "aW0trV9uUrnIzLnh2WHDvC";
}

static void
  sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void *
  chartInstanceVar)
{
  ...
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
  initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (void *chartInstanceVar)
{
  enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2();/* state var info */
...
extern void
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
...
static void
  sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    (S, st);
...
static void
  sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      ...
      unload_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_optimization_info();
    }

    finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
      ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_optimization_info();
  ...
  ssSetChecksum0(S,(430622276U));
  ssSetChecksum1(S,(1528238484U));
  ssSetChecksum2(S,(2950868844U));
  ssSetChecksum3(S,(4008920426U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  SFc3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  ...
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
...
void c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_method_dispatcher.\n"
