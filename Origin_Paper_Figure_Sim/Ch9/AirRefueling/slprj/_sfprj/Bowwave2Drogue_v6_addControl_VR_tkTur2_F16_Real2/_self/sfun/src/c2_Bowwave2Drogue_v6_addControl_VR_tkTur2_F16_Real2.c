...
#include "c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2.h"
...
static void initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void
  initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
...
static const mxArray
  *get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance, const mxArray *c2_st);
static void finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
static void registerMessagesc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
   *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
   ...
   *c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea, const
   ...
   *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    = 0U;
}
   ...
   *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ...
    "is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2");
  sf_mex_destroy(&c2_u);
   ...
   *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(chartInstance);
...
const mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea),
    &c2_thisId);
  sf_mex_destroy
    (&c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Rea);
  return c2_y;
...
void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_check_sum
  (mxArray *plhs[])
{
...
mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_autoinheritance_info
  (void)
{
...
mxArray
  *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_third_party_uses_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_get_check_sum
    (&mxChecksum);
...
static void
  sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void *
  chartInstanceVar)
{
  ...
  initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
  initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (void *chartInstanceVar)
{
  enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2();/* state var info */
...
extern void
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
...
static void
  sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    (S, st);
...
static void
  sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
      ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2
  (SimStruct *S)
{
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2InstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  ...
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2;
...
void c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Bowwave2Drogue_v6_addControl_VR_tkTur2_F16_Real2_method_dispatcher.\n"
