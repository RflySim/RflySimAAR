...
static void initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   const mxArray *c3_st);
static void finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void registerMessagesc3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
...
static void c3_null(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
...
static real_T c3_eml_xnrm2
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   real_T c3_x[6]);
static void c3_realmin(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *
  chartInstance);
static real_T c3_abs(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
...
static void c3_eps(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                   *chartInstance);
static void c3_c_eml_scalar_eg
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void c3_b_eml_error
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static real_T c3_sqrt(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T c3_x);
...
static void c3_eml_xrotg
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   ...
   real_T *c3_s);
static void c3_eml_xrot(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
...
static void c3_d_eml_scalar_eg
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static real_T c3_acos(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T c3_x);
static void c3_d_eml_error
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static real_T c3_norm(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
...
static uint8_T c3_k_emlrt_marshallIn
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   const mxArray *c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur, const
...
static void c3_b_sqrt(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T *c3_x);
...
static void c3_b_acos(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T *c3_x);
  ...
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur = 0U;
}
  ...
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal =
    chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
   ...
   const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur =
    ...
    "is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur");
  sf_mex_destroy(&c3_u);
  ...
  (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance;
  chartInstance = (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *)
    chartInstanceVoid;
   ...
   char_T *c3_identifier)
{
  ...
  c3_y = c3_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur);
  return c3_y;
}
...
void sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"y\",},{M[8],M[0],T\"is_active_c3_Bowwave2Drogue_v6_addControl_VR_tkTur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
  initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  sf_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur();/* state var info */
...
extern void sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
}

static void sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(S, st);
}

static void sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Bowwave2Drogue_v6_addControl_VR_tkTur_optimization_info();
    }

    finalize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
      ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Bowwave2Drogue_v6_addControl_VR_tkTur_optimization_info();
...
static void mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *S)
{
  SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance;
  chartInstance = (SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *)
    utMalloc(sizeof(SFc3_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur;
...
void c3_Bowwave2Drogue_v6_addControl_VR_tkTur_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Bowwave2Drogue_v6_addControl_VR_tkTur_method_dispatcher.\n"
