...
static void initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTu
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   const mxArray *c2_st);
static void finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static void registerMessagesc2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
...
static real_T c2_mpower(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T c2_x);
static void c2_eml_error
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance);
static real_T c2_abs(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                     *chartInstance, real_T c2_x);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   const mxArray *c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur, const
   char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance,
   const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct
                      *chartInstance, real_T *c2_x);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur = 0U;
}
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
   ...
   const mxArray *c2_st)
{
  ...
  *c2_Fz = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
  ...
  chartInstance->c2_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur =
    ...
    "is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur");
  sf_mex_destroy(&c2_u);
  ...
  (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *)
    chartInstanceVoid;
   ...
   char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur);
  return c2_y;
}
...
void sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Fx\",},{M[1],M[8],T\"Fy\",},{M[1],M[9],T\"Fz\",},{M[8],M[0],T\"is_active_c2_Bowwave2Drogue_v6_addControl_VR_tkTur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
  initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  sf_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
}

static void sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(S, st);
}

static void sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
      ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Bowwave2Drogue_v6_addControl_VR_tkTur
    ((SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(SimStruct *S)
{
  SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *chartInstance;
  chartInstance = (SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct *)
    utMalloc(sizeof(SFc2_Bowwave2Drogue_v6_addControl_VR_tkTurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur;
...
void c2_Bowwave2Drogue_v6_addControl_VR_tkTur_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Bowwave2Drogue_v6_addControl_VR_tkTur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Bowwave2Drogue_v6_addControl_VR_tkTur_method_dispatcher.\n"
