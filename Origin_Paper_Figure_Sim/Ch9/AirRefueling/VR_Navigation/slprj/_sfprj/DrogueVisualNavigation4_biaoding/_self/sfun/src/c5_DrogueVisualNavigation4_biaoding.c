...
#include "c5_DrogueVisualNavigation4_biaoding.h"
...
static void initialize_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void initialize_params_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void enable_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void disable_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void set_sim_state_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void sf_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c5_chartstep_c5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void initSimStructsc5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void registerMessagesc5_DrogueVisualNavigation4_biaoding
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
...
static void c5_emlrt_marshallIn
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_yy, const char_T *c5_identifier, real_T c5_y[412800]);
static void c5_b_emlrt_marshallIn
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[412800]);
...
static void c5_d_emlrt_marshallIn
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y_data[412800],
...
static void c5_g_emlrt_marshallIn
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, uint32_T c5_y[412800]);
...
static void c5_check_forloop_overflow_error
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, boolean_T
   c5_overflow);
static void c5_eml_find(SFc5_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c5_eml_scalar_eg(SFc5_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static real_T c5_mean(SFc5_DrogueVisualNavigation4_biaodingInstanceStruct
                      *chartInstance, real_T c5_x_data[412800], int32_T
                      c5_x_sizes[1]);
...
static uint8_T c5_i_emlrt_marshallIn
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_DrogueVisualNavigation4_biaoding, const char_T
   *c5_identifier);
  ...
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_DrogueVisualNavigation4_biaoding = 0U;
}
  ...
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal =
    chartInstance->c5_is_active_c5_DrogueVisualNavigation4_biaoding;
   ...
   mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_DrogueVisualNavigation4_biaoding =
    ...
    "is_active_c5_DrogueVisualNavigation4_biaoding");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_DrogueVisualNavigation4_biaoding(chartInstance);
  ...
  (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_DrogueVisualNavigation4_biaoding(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance;
  chartInstance = (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *)
    chartInstanceVoid;
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_DrogueVisualNavigation4_biaoding), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_DrogueVisualNavigation4_biaoding);
  return c5_y;
}
...
void sf_c5_DrogueVisualNavigation4_biaoding_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_DrogueVisualNavigation4_biaoding_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_DrogueVisualNavigation4_biaoding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_DrogueVisualNavigation4_biaoding
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"yy\",},{M[8],M[0],T\"is_active_c5_DrogueVisualNavigation4_biaoding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_DrogueVisualNavigation4_biaoding_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
  initialize_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  enable_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  disable_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  sf_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_DrogueVisualNavigation4_biaoding(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_DrogueVisualNavigation4_biaoding
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c5_DrogueVisualNavigation4_biaoding
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c5_DrogueVisualNavigation4_biaoding(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_DrogueVisualNavigation4_biaoding(S);
}

static void sf_opaque_set_sim_state_c5_DrogueVisualNavigation4_biaoding
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_DrogueVisualNavigation4_biaoding(S, st);
}

static void sf_opaque_terminate_c5_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_DrogueVisualNavigation4_biaoding
      ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_DrogueVisualNavigation4_biaoding
    ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_DrogueVisualNavigation4_biaoding(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_DrogueVisualNavigation4_biaoding
      ((SFc5_DrogueVisualNavigation4_biaodingInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c5_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance;
  chartInstance = (SFc5_DrogueVisualNavigation4_biaodingInstanceStruct *)
    utMalloc(sizeof(SFc5_DrogueVisualNavigation4_biaodingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c5_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_DrogueVisualNavigation4_biaoding;
...
void c5_DrogueVisualNavigation4_biaoding_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_DrogueVisualNavigation4_biaoding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_DrogueVisualNavigation4_biaoding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_DrogueVisualNavigation4_biaoding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_DrogueVisualNavigation4_biaoding_method_dispatcher.\n"
