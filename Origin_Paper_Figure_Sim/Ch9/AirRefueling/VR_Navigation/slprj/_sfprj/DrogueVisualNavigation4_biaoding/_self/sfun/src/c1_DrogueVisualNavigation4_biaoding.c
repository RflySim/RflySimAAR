...
static const char * c1_debug_family_names[32] = { "L", "N", "Ir", "dX", "dY",
  "k", "r", "c", "m", "cX", "cY", "cR", "alpha", "x", "y", "mm", "nn", "i", "j",
  "f", "s", "xw", "yw", "zw", "nargin", "nargout", "u1", "u2", "u3", "yy", "yy1",
  "yy2" };

/* Function Declarations */
static void initialize_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void initialize_params_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void enable_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void disable_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void set_sim_state_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void finalize_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void sf_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_chartstep_c1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void initSimStructsc1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void registerMessagesc1_DrogueVisualNavigation4_biaoding
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_yy2, const char_T *c1_identifier, real_T c1_y[3]);
...
static void c1_e_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_yy, const char_T *c1_identifier, real_T c1_y[412800]);
static void c1_f_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[412800]);
...
static void c1_j_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y_data[412800],
   int32_T c1_y_sizes[1]);
...
static void c1_m_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, uint32_T c1_y[412800]);
...
static void c1_check_forloop_overflow_error
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, boolean_T
   c1_overflow);
static void c1_eml_find(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_eml_scalar_eg(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static real_T c1_mean(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
                      *chartInstance, real_T c1_x_data[412800], int32_T
                      c1_x_sizes[1]);
static void c1_b_check_forloop_overflow_error
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, boolean_T
   c1_overflow);
static void c1_power(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_b_eml_scalar_eg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_mldivide(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_c_eml_scalar_eg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_realmin(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static void c1_eps(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
                   *chartInstance);
static void c1_d_eml_scalar_eg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, real_T
   c1_A_data[9], int32_T c1_A_sizes[2], real_T c1_b_A_data[9], int32_T
   c1_b_A_sizes[2], int32_T c1_ipiv[3], int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x_data[9], int32_T c1_x_sizes[2],
  int32_T c1_ix0);
static void c1_eml_xger(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_eml_warning(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static void c1_eml_xtrsm(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_below_threshold
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_e_eml_scalar_eg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static void c1_b_eml_xtrsm(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_A_data[9], int32_T c1_A_sizes[2], real_T c1_B_data
  [10], int32_T c1_B_sizes[1], real_T c1_b_B_data[10], int32_T c1_b_B_sizes[1]);
static void c1_eml_qrsolve(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_A_data[30], int32_T c1_A_sizes[2], real_T c1_B_data
  [10], int32_T c1_B_sizes[1], real_T c1_Y[3]);
static void c1_f_eml_scalar_eg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance);
static real_T c1_sqrt(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
                      *chartInstance, real_T c1_x);
static void c1_eml_error(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static real_T c1_eml_xnrm2(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x_data[30], int32_T c1_x_sizes[2],
  int32_T c1_ix0);
static int32_T c1_b_eml_ixamax
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, int32_T
   c1_n, real_T c1_x[3], int32_T c1_ix0);
static void c1_eml_xswap(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x_data[30], int32_T c1_x_sizes[2],
...
static void c1_eml_matlab_zlarfg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, int32_T
   ...
   real_T *c1_tau);
static void c1_eml_xscal(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_b_eml_xnrm2(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance);
static real_T c1_b_eml_xscal(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_x);
...
static void c1_eml_xgemv(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static void c1_b_eml_xger(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
...
static void c1_b_eml_warning(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_varargin_2, char_T c1_varargin_3[14]);
static real_T c1_mpower(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
...
static uint8_T c1_q_emlrt_marshallIn
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, const
   mxArray *c1_b_is_active_c1_DrogueVisualNavigation4_biaoding, const char_T
   *c1_identifier);
...
static void c1_c_eml_xger(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
  int32_T c1_iy0, real_T c1_A_data[9], int32_T c1_A_sizes[2], int32_T c1_ia0);
static void c1_c_eml_xtrsm(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_A_data[9], int32_T c1_A_sizes[2], real_T c1_B_data
  [10], int32_T c1_B_sizes[1]);
static void c1_d_eml_xtrsm(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T c1_A_data[9], int32_T c1_A_sizes[2], real_T c1_B_data
  [10], int32_T c1_B_sizes[1]);
static void c1_b_sqrt(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
                      *chartInstance, real_T *c1_x);
static void c1_b_eml_xswap(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x_data[30], int32_T c1_x_sizes[2],
...
static real_T c1_c_eml_matlab_zlarfg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, int32_T
   c1_n, real_T *c1_alpha1, real_T c1_x_data[30], int32_T c1_x_sizes[2], int32_T
   c1_ix0);
static void c1_c_eml_xscal(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_a, real_T c1_x_data[30], int32_T
  c1_x_sizes[2], int32_T c1_ix0);
static real_T c1_d_eml_matlab_zlarfg
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, real_T
   *c1_alpha1, real_T *c1_x);
static void c1_d_eml_xscal(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, real_T *c1_x);
static void c1_b_eml_matlab_zlarf
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance, int32_T
   c1_m, int32_T c1_n, int32_T c1_iv0, real_T c1_tau, real_T c1_C_data[30],
   int32_T c1_C_sizes[2], int32_T c1_ic0, int32_T c1_ldc, real_T c1_work[3]);
static void c1_b_eml_xgemv(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_A_data[30], int32_T
  c1_A_sizes[2], int32_T c1_ia0, int32_T c1_lda, real_T c1_x_data[30], int32_T
  c1_x_sizes[2], int32_T c1_ix0, real_T c1_y[3]);
static void c1_d_eml_xger(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
  real_T c1_y[3], real_T c1_A_data[30], int32_T c1_A_sizes[2], int32_T c1_ia0,
  int32_T c1_lda);
  ...
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DrogueVisualNavigation4_biaoding = 0U;
}
  ...
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal =
    chartInstance->c1_is_active_c1_DrogueVisualNavigation4_biaoding;
   ...
   mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DrogueVisualNavigation4_biaoding =
    ...
    "is_active_c1_DrogueVisualNavigation4_biaoding");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DrogueVisualNavigation4_biaoding(chartInstance);
  ...
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_DrogueVisualNavigation4_biaoding(chartInstance);
  ...
  (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 32U, 33U, c1_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_j, 18U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_f, 19U, c1_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_s, 20U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_xw, 21U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_yw, 22U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_zw, 23U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_b_k, MAX_uint32_T,
    c1_f_sf_marshallOut, c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargin, 24U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 25U, c1_f_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_u1, 26U, c1_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_u2, 27U, c1_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_u3, 28U, c1_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_yy, 29U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_yy1, 30U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_yy2, 31U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_zw = c1_i_y + 0.16253357116947409;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance;
  chartInstance = (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_DrogueVisualNavigation4_biaoding_get_eml_resolved_functions_info(void)
{
   ...
   *c1_identifier)
{
  ...
  c1_y = c1_r_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_DrogueVisualNavigation4_biaoding), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_DrogueVisualNavigation4_biaoding);
  return c1_y;
}
...
void sf_c1_DrogueVisualNavigation4_biaoding_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3655029037U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2069327019U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4042399065U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(440445700U);
}

mxArray *sf_c1_DrogueVisualNavigation4_biaoding_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pkqKS2kfK2Qx662DtxakfC");
...
mxArray *sf_c1_DrogueVisualNavigation4_biaoding_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_DrogueVisualNavigation4_biaoding
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"yy\",},{M[1],M[11],T\"yy1\",},{M[1],M[12],T\"yy2\",},{M[8],M[0],T\"is_active_c1_DrogueVisualNavigation4_biaoding\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DrogueVisualNavigation4_biaoding_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1218);
...
{
  return "Y2AKP5uzsqarucrO1972HB";
}

static void sf_opaque_initialize_c1_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
  initialize_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  enable_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  disable_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  sf_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_DrogueVisualNavigation4_biaoding(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DrogueVisualNavigation4_biaoding
    ();                                /* state var info */
...
extern void sf_internal_set_sim_state_c1_DrogueVisualNavigation4_biaoding
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_DrogueVisualNavigation4_biaoding(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DrogueVisualNavigation4_biaoding(S);
}

static void sf_opaque_set_sim_state_c1_DrogueVisualNavigation4_biaoding
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_DrogueVisualNavigation4_biaoding(S, st);
}

static void sf_opaque_terminate_c1_DrogueVisualNavigation4_biaoding(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c1_DrogueVisualNavigation4_biaoding
      ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DrogueVisualNavigation4_biaoding
    ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DrogueVisualNavigation4_biaoding(SimStruct
  *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_DrogueVisualNavigation4_biaoding
      ((SFc1_DrogueVisualNavigation4_biaodingInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(1745479871U));
  ssSetChecksum1(S,(657300638U));
  ssSetChecksum2(S,(278492396U));
  ssSetChecksum3(S,(1406386552U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DrogueVisualNavigation4_biaoding(SimStruct *S)
{
  SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *chartInstance;
  chartInstance = (SFc1_DrogueVisualNavigation4_biaodingInstanceStruct *)
    utMalloc(sizeof(SFc1_DrogueVisualNavigation4_biaodingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_DrogueVisualNavigation4_biaoding;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DrogueVisualNavigation4_biaoding;
...
void c1_DrogueVisualNavigation4_biaoding_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DrogueVisualNavigation4_biaoding(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DrogueVisualNavigation4_biaoding(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DrogueVisualNavigation4_biaoding(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DrogueVisualNavigation4_biaoding_method_dispatcher.\n"
